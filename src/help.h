...
string H1 =  "rita is an interactive application to solve modelling problems involving\n"
             ...
             "rita execution enables defining a variety of entities to define various problems:\n"
             "algebraic equations, ordinary differential equations, partial differential equations,\n"
             "functions, fields, matrices, meshes, grids, ...\n\n"
             ...
             "calc          Define some parameters to be used in data\n"
             ...
             "optim         Set problem as an optimization one\n"
